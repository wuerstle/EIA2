...
(function (L6_InterfaceBee) {
    ...
    function drawBee(_b) {
        ...
        crc2.arc(_b.x + 4, _b.y, _b.size, 0, 2 * Math.PI);
        crc2.closePath();
        crc2.fill();
        crc2.stroke();
        crc2.beginPath();
        crc2.fillStyle = _b.color;
        crc2.arc(_b.x + 8, _b.y, _b.size, 0, 2 * Math.PI);
        crc2.closePath();
        crc2.fill();
        crc2.stroke();
    }
})(L6_InterfaceBee || (L6_InterfaceBee = {}));
